export const linkClass =
	"text-[var(--cta-one)] cursor-pointer hover:text-[var(--cta-one-hover)] transition-all duration-300 ease-in-out";
export const buttonClass =
	"w-fit my-4 py-4 px-4 md:px-16 text-xl rounded bg-[var(--cta-one)] text-white font-bold transition-all hover:bg-[var(--cta-one-hover)] hover:scale-105";
